...
DownloadAndBuildAutotools.sh version 2.16
...
Options:
 ...
 --automake-version=<nn>  Automake version to download and build, defaults to 1.18
 ...
 --prefix=/some/dir       Directory where the binaries will be installed, see notes below.
                          Defaults to: autoconf-2.72-automake-1.18-libtool-2.5.3
 --help     displays this help text
 --version  displays the tool's version number (currently 2.16)
 --license  prints license information

Usage example:
  % cd some/dir  # The file cache and intermediate build results will land there.
  % ./DownloadAndBuildAutotools.sh --autoconf-version=2.72 --automake-version=1.18 --libtool-version=2.5.3
...
- Latest as of June   2025: Autoconf 2.72, Automake 1.18  , Libtool 2.5.3
