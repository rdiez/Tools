...
DownloadAndBuildAutotools.sh version 2.13
...
Options:
 ...
 --prefix=/some/dir       Directory where the binaries will be installed, see notes below.
                          Defaults to: autoconf-2.71-automake-1.16.3-libtool-2.4.6
 --help     displays this help text
 --version  displays the tool's version number (currently 2.13)
 --license  prints license information

Usage example:
  % cd some/dir  # The file cache and intermediate build results will land there.
  % ./DownloadAndBuildAutotools.sh --autoconf-version=2.71 --automake-version=1.16.3 --libtool-version=2.4.6
...
- Latest as of February 2021: Autoconf 2.71, Automake 1.16.3, Libtool 2.4.6
