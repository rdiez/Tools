...
If you run each command with the RunAndReport.sh wrapper, you can use GenerateHtmlReport.pl
to create a report table which neatly summarises the succedded (green) or failed (red) status of each task.
You can then drill down to the separate task log files.
