...
Print this tool's name and version number (0.85).
...
values in the checksum type column had changed. Empty files now have "none" as
the checksum type and value, and support for the "Adler-32" type was introduced.
