...
On Debian systems, remove packages I<< locate >> and I<< mlocate >>, and then install this package to prevent
them from ever being installed again.

This package is not actually a hard, unsurmountable ban, but you should get a conflict warning from your favourite
package manager if something wants to install I<< locate >> or I<< mlocate >> again.

Note that, if you just remove package I<< mlocate >>, then tool I<< updatedb >> ends up referencing I<< /usr/bin/updatedb.findutils >> instead
