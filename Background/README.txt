...
background.sh version 2.0
Copyright (c) 2011-2014 R. Diez - Licensed under the GNU AGPLv3

This tool runs the given process under a combination of ('nice -n 15' + 'time' + 'tee') commands and displays a visual notification when finished.
...
- You want to carry on using the computer for other tasks. That long process should run with a low CPU and disk priority in the background (command 'nice -n 15').
