...
create_link "CallEmacsFunction" "call-emacs-function.sh"
create_link "CallEmacsFunction" "ediff.sh"
...
create_link "BrailleToBitmap" "BrailleToBitmap.pl"
create_link "DeleteDirEvenIfWriteProtected" "delete-dir-even-if-write-protected.sh"
