...
First of all, unmount any partitions on the source disk which are mounted as read/write.

Afterwards, prepare and run a command like this:
...
Step 2) Prepare and run a command like this:
