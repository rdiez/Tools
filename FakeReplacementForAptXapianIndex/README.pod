...
for easy reading:
  ...
  perl -MPod::Simple::HTML  -e "\$p = Pod::Simple::HTML->new; \$p->index( 1 ); \$p->output_fh( *STDOUT{IO} ); \$p->force_title('Fake Replacement for Debian Package apt-xapian-index'); \$p->parse_file('README.pod');"  >README.html
